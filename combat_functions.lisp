...
(defun ranged_weapon_damage (c)
	(cond ((not (creature-ranged_weapon c)) 0)
	      (t (roll_dice (first (creature-ranged_weapon c)) (second (creature-ranged_weapon c))))
	)
)

(defun to_damage_ranged (c)
	(+ (ranged_weapon_damage c) (floor (/ (creature-dexterity c) 5)))
)
